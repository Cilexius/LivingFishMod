...
public class RenderIronFishHook extends Render<EntityIronFishHook> {
    private static final ResourceLocation FISH_PARTICLES = new ResourceLocation("textures/particle/particles.png");

    public RenderIronFishHook(RenderManager renderManager) {
        super(renderManager);
    }

    public void doRender(EntityIronFishHook entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    protected ResourceLocation getEntityTexture(EntityIronFishHook entity) {
