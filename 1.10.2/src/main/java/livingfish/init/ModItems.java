...
public class ModItems {
	...
	public void init() {
		...
		fishbones = new Item().setCreativeTab(LivingFish.instance.tab);
		RegistryUtils.setItemNames(fishbones, "fishbones");
		ironhook = new Item().setCreativeTab(LivingFish.instance.tab);
		RegistryUtils.setItemNames(ironhook, "ironhook");
		
		fishingrod = new Fishingrod().setCreativeTab(LivingFish.instance.tab);
