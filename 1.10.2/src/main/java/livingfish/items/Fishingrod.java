...
public class Fishingrod extends ItemFishingRod {
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack stack, World world, EntityPlayer player, EnumHand hand) {
    	...
    	if (!world.isRemote && player.isSneaking() && !this.hasBait(stack) && player.getHeldItemOffhand() != null) {
        ...
        if (player.fishEntity != null) {
            ...
            if (!world.isRemote) {
                world.spawnEntityInWorld(new EntityIronFishHook(world, player, this, this.hasBait(stack)));
            } else {
            	world.spawnEntityInWorld(new EntityIronFishHook(world, player));
            }
            player.swingArm(hand);
